...
import (
	...
	"github.com/cybernamix/celeritas/cache"
	"github.com/cybernamix/celeritas/mailer"
	"github.com/cybernamix/celeritas/render"
	"github.com/cybernamix/celeritas/session"
...
func (c *Celeritas) New(rootPath string) error {
	pathConfig := initPaths{
		rootPath: rootPath,
		folderNames: []string{"handlers", "migrations", "views", "mail", "data",
	...
	//read .env  - requires github.com/joho/godotenv
	...
	c.createRenderer()
	// start in background listening for mail messages
...
// Init creates necessary fodlers for Celeritas Application
