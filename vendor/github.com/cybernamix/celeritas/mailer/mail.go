...
func (m *Mail) ChooseAPI(msg Message) error {
	...
	default:
		return fmt.Errorf("unknown api %s; only mailgun, sendgrid, sparkpost accepted", m.API)
	}
}
...
// SendSMTPMessage builds and sends an email message using SMTP. This is cvalled by ListenForMail, and also can be called directly when necessary
...
// converts the encryption string to something acceptable for the go-simple-mail pkg
